...
-- Set up Prettier options for jsx and tsx
...
-- vim.cmd [[
--   autocmd FileType javascript,javascriptreact setlocal tabstop=4 shiftwidth=4 softtabstop=4
-- ]]
--
-- -- Configure Neoformat to use Prettier for js
-- vim.g.neoformat_enabled_javascript = {'prettier'}
--
-- -- Set up Prettier options js
-- vim.g.neoformat_javascript_prettier = {
--   exe = 'prettier',
--   args = {'--stdin-filepath', '%:p', '--tab-width=4', '--single-quote', '--trailing-comma=all', '--print-width=80'},
--   stdin = 1
-- }
--
-- -- Configure Neoformat to use Prettier for jsx
-- vim.g.neoformat_enabled_javascriptreact = {'prettier'}
--
-- -- Set up Prettier options for jsx
-- vim.g.neoformat_javascriptreact_prettier = {
--   exe = 'prettier',
--   args = {'--stdin-filepath', '%:p', '--tab-width=4', '--single-quote', '--trailing-comma=all', '--print-width=80'},
--   stdin = 1
